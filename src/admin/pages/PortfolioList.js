...
{isLogin} + Value
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-6 lg:px-6 ">
      ...
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
        ...
        <div className="py-0 items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <div className="p-0">
          <a href="#">
            <img
  ...
  <div className=" w-full lg:max-w-full lg:flex">
    <div
      ...
      style={{ backgroundImage: 'url("https://storage.googleapis.com/tailwind-awesome/y3gzaxk0zkl58d2lyum7hft8lva2")' }}
      title="Mountain"
    ></div>
