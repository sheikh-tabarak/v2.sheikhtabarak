...
export default function Dashboard() {
  ...
  function moreIconToogle() {
    Toggled.moreicon === true
      ? setToggled({
          moreicon: false,
        })
      : setToggled({
  ...
  return isLoading === true ? (
    ...
    <div className="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <div
              className={
                Toggled.notification === true
                  ? "absolute top-10 right-0 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
                  : " hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
              }
            ...
            <div
              className={
                Toggled.moreicon == true
                  ? "absolute top-10 right-0 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
            ...
            <div
              className={
                Toggled.profile === true
                  ? "absolute top-10 right-0 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                  : "hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
              }
              id="dropdown"
            >
      ...
      <aside
        className={
          Toggled.drawer === true
            ? "fixed top-0 left-0 z-40 w-64 h-screen pt-14 bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
            : "fixed top-0 left-0 z-40 w-64 h-screen pt-14 bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700 transition-transform -translate-x-full "
        }
        aria-label="Sidenav"
