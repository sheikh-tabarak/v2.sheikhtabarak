...
export default function AllProjects() {
  ...
  // async function AreYouSure(ProjectId) {
  //   handleOpen;
  // }
  ...
  return isLoading === true ? (
    ...
    <Routes>
                      ...
                      <td className=" w-1/6 px-6 py-4">
                        ...
                        >
                          <div className="flex row">
                            <div className="px-2">
                              <svg
                                onClick={async () => {
                                  ...
                                  await delay(2000);
                                  // await fetchProjectstoUpdate(product.project_id);
                            ...
                            <ConfirmationDialog
                              onConfirm={async () => {
                                await deleteProject(product.project_id);
                              }}
      ...
      <Route
        path="/update-project"
        element={<UpdateProject name={ProjecttoUpdate.name} />}
      ></Route>
    </Routes>
  );
}
