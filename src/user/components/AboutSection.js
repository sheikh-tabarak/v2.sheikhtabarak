...
export default function AboutSection() {
        ...
        <div class="mr-auto place-self-center lg:col-span-7">
          <div className="">
            <div className="flex">
              ...
              <h1 id="" className="col text-[20px] leading-8 font-bold mb-4 tracking-tight text-[#CCD6F6] md:text-[40px] lg:text-[24px]">
                About me.
              </h1>
            </div>
  ...
  {/* <ul className="skills-list">
    <li className="list-itembo">JavaScript (ES6+)</li>
    <li>TypeScript</li>
    <li>React</li>
    <li>Eleventy</li>
    <li>Node.js</li>
    <li>WordPress</li>
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:block align-middle">
          <img
